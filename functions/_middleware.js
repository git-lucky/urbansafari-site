...
export async function onRequest(context) {
  ...
  return new HTMLRewriter()
    ...
    .on('[data-city-eyebrow]',text(`Corporate team building · ${city.label}`))
    .on('[data-city-headline]',text(`Your ${city.name} team’s next great story.`))
    .on('[data-city-description]',text(description))
    .on('[data-city-proof]',text(`Built for ${city.name}`))
